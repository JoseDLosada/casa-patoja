                    ...
                    <form class="form-horizontal" method="POST" action="?fControlador=nomina&fAccion=GuardarNomina">
                      ...
                      <fieldset>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-lg-10">
                            <input class="form-control" name="nom-id" type="number" placeholder="ID Gasto" readonly value="<?=$nomina->getNomina_id()?>">
                          </div>                 
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-lg-10">
                            <input required class="form-control" name="nom-pago" type="number" placeholder="0" value="<?=$nomina->getNomina_pago()?>" >
                          </div>                 
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-lg-10">
                            <input required class="form-control" name="nom-fecha" type="date" value="<?= $nomina->getNomina_fecha()->format('Y-m-d') ?>">
                          </div>
                        </div>
